...
const First = () => {
  return (
    ...
    <div className="flex xl:flex-col-3  xl:my-48">
      <div className="mt-10">
      <Image src={mon} alt="alt" width={180} height={100} className=" xl:ml-16 text-center"/>
      <h2 className="h1 text-primary xl:my-10">No upfront costs </h2>
      <h3 className="h3 text-/100 text-center"> There are no costs to join the <br/>program, nor fees once you join, nor <br/>investment required for assets. <br/>Econergy takes care of it all.</h3>
      </div>
      <div className="xl:mx-20 xl:mb-60">
