    ...
    <section className='bg-frost p-10'>
        ...
        <div className="flex flex-col-2 mx-20">
            <div className="my-8">
                ...
                <button className=" text-center text-white/100 bg-greet py-5 px-8 my-8 mx-48">Get Started</button>
            </div>
            <div className="my-8">
                ...
                <button className=" text-center text-white/100 bg-greet py-5 pr-8 pl-4 my-8 mx-48">Start a coalition</button>
            </div>
        </div>
