...
const Form = () => {
  return (
    <section  className='my-28' >
       <div className="bg-white  py-48 my-16 pl-44 px-48 mx-48">
        ...
        <form action="" className='mt-14 mx-16'>
        ...
        <div className="flex flex-col-2 mx-16 my-8">
          <div className="">
            <form action="ml-">
              ...
              <input
                ...
                name="name"
                placeholder=""
                className="w-[420px] border border-[grey] rounded-lg py-3 mx px-2 my-6 outline-none	bg-transparent"
              />
            </form>
          </div>
          <div className="mx-3">
            <form action="">
              ...
              <input
                ...
                name="name"
                placeholder=""
                className="w-[420px] h-[] border border-[grey] rounded-lg py-3  px-5 my-6 outline-none	bg-transparent"
              />
            </form>
          </div>
        </div>
        <div className="flex flex-col-2">
          ...
          <form action="">
              ...
              <input
                ...
                className="h3 w-[420px]  border border-[grey] rounded-lg py-3  px-5 my-6 outline-none	bg-transparent"
              />
            </form>
          </div>
        </div>
        ...
        <button className='bg-greet h3 px-8 ml-16 py-5 text-frost'>Upload Utility Bill</button>

        <form action="" className='my-8  ml-16'>
              ...
              <input
                ...
                name="name"
                placeholder=""
                className="h3 w-[880px]  border border-[grey] rounded-lg py-20  px-5 my-6 outline-none	bg-transparent"
              />
            </form>
          
            <button className="flex h3 text-white bg-greet px-10 mx-16 py-5 justify-between items-center ">Submit</button>
